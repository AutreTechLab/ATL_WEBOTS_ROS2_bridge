...
#ifndef WEBOTS_INTERFACES__MSG__DETAIL__WEBOTS_THYMIO2_CONTROLLER__STRUCT_H_
#define WEBOTS_INTERFACES__MSG__DETAIL__WEBOTS_THYMIO2_CONTROLLER__STRUCT_H_
...
// Struct defined in msg/WebotsThymio2Controller in the package webots_interfaces.
typedef struct webots_interfaces__msg__WebotsThymio2Controller
{
  ...
  rosidl_runtime_c__int64__Sequence leds_circle;
  ...
  rosidl_runtime_c__double__Sequence prox_ground_ambiant;
  rosidl_runtime_c__double__Sequence prox_ground_delta;
  rosidl_runtime_c__double__Sequence prox_ground_reflected;
  rosidl_runtime_c__double__Sequence prox_horizontal;
...
// Struct for a sequence of webots_interfaces__msg__WebotsThymio2Controller.
typedef struct webots_interfaces__msg__WebotsThymio2Controller__Sequence
{
  webots_interfaces__msg__WebotsThymio2Controller * data;
...
#endif  // WEBOTS_INTERFACES__MSG__DETAIL__WEBOTS_THYMIO2_CONTROLLER__STRUCT_H_
