...
#ifndef WEBOTS_INTERFACES__SRV__DETAIL__WEBOTS_THYMIO2_MOTOR_SRV__FUNCTIONS_H_
#define WEBOTS_INTERFACES__SRV__DETAIL__WEBOTS_THYMIO2_MOTOR_SRV__FUNCTIONS_H_
...
/// Initialize srv/WebotsThymio2MotorSrv message.
/**
...
/// Finalize srv/WebotsThymio2MotorSrv message.
/**
...
/// Create srv/WebotsThymio2MotorSrv message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * webots_interfaces__srv__WebotsThymio2MotorSrv_Request__init().
...
/// Destroy srv/WebotsThymio2MotorSrv message.
/**
 * It calls
 * webots_interfaces__srv__WebotsThymio2MotorSrv_Request__fini()
...
/// Initialize array of srv/WebotsThymio2MotorSrv messages.
/**
...
/// Finalize array of srv/WebotsThymio2MotorSrv messages.
/**
 * It calls
 * webots_interfaces__srv__WebotsThymio2MotorSrv_Request__fini()
...
/// Create array of srv/WebotsThymio2MotorSrv messages.
/**
 * It allocates the memory for the array and calls
 * webots_interfaces__srv__WebotsThymio2MotorSrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/WebotsThymio2MotorSrv messages.
/**
 * It calls
 * webots_interfaces__srv__WebotsThymio2MotorSrv_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * webots_interfaces__srv__WebotsThymio2MotorSrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_webots_interfaces
...
/**
 * It calls
 * webots_interfaces__srv__WebotsThymio2MotorSrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_webots_interfaces
...
/**
 * It allocates the memory for the array and calls
 * webots_interfaces__srv__WebotsThymio2MotorSrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_webots_interfaces
...
/**
 * It calls
 * webots_interfaces__srv__WebotsThymio2MotorSrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // WEBOTS_INTERFACES__SRV__DETAIL__WEBOTS_THYMIO2_MOTOR_SRV__FUNCTIONS_H_
