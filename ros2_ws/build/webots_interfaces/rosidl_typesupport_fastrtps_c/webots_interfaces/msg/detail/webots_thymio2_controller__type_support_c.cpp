...
#include "webots_interfaces/msg/detail/webots_thymio2_controller__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // acc, leds_circle, prox_ground_ambiant, prox_ground_delta, prox_ground_reflected, prox_horizontal, timer_period
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // acc, leds_circle, prox_ground_ambiant, prox_ground_delta, prox_ground_reflected, prox_horizontal, timer_period
#include "rosidl_runtime_c/string.h"  // button_backward, button_center, button_forward, button_left, button_right, debug_message, event_args, event_source, leds_bottom_left, leds_bottom_right, leds_top, mic_intensity, mic_threshold, motor_left_pwm, motor_left_speed, motor_left_target, motor_right_pwm, motor_right_speed, motor_right_target, prox_comm_rx, prox_comm_tx, rc5_address, rc5_command
#include "rosidl_runtime_c/string_functions.h"  // button_backward, button_center, button_forward, button_left, button_right, debug_message, event_args, event_source, leds_bottom_left, leds_bottom_right, leds_top, mic_intensity, mic_threshold, motor_left_pwm, motor_left_speed, motor_left_target, motor_right_pwm, motor_right_speed, motor_right_target, prox_comm_rx, prox_comm_tx, rc5_address, rc5_command

// forward declare type support functions


using _WebotsThymio2Controller__ros_msg_type = webots_interfaces__msg__WebotsThymio2Controller;

static bool _WebotsThymio2Controller__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _WebotsThymio2Controller__ros_msg_type * ros_message = static_cast<const _WebotsThymio2Controller__ros_msg_type *>(untyped_ros_message);
...
static bool _WebotsThymio2Controller__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _WebotsThymio2Controller__ros_msg_type * ros_message = static_cast<_WebotsThymio2Controller__ros_msg_type *>(untyped_ros_message);
  // Field name: debug_message
  {
    std::string tmp;
    cdr >> tmp;
  ...
  // Field name: leds_circle
  {
    ...
    if (ros_message->leds_circle.data) {
      rosidl_runtime_c__int64__Sequence__fini(&ros_message->leds_circle);
    }
    if (!rosidl_runtime_c__int64__Sequence__init(&ros_message->leds_circle, size)) {
  ...
  // Field name: prox_ground_ambiant
  {
    ...
    if (ros_message->prox_ground_ambiant.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->prox_ground_ambiant);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->prox_ground_ambiant, size)) {
  ...
  // Field name: prox_ground_delta
  {
    ...
    if (ros_message->prox_ground_delta.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->prox_ground_delta);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->prox_ground_delta, size)) {
  ...
  // Field name: prox_ground_reflected
  {
    ...
    if (ros_message->prox_ground_reflected.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->prox_ground_reflected);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->prox_ground_reflected, size)) {
  ...
  // Field name: prox_horizontal
  {
    ...
    if (ros_message->prox_horizontal.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->prox_horizontal);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->prox_horizontal, size)) {
...
size_t get_serialized_size_webots_interfaces__msg__WebotsThymio2Controller(
  const void * untyped_ros_message,
...
static uint32_t _WebotsThymio2Controller__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_webots_interfaces__msg__WebotsThymio2Controller(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_webots_interfaces
size_t max_serialized_size_webots_interfaces__msg__WebotsThymio2Controller(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _WebotsThymio2Controller__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_webots_interfaces__msg__WebotsThymio2Controller(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_WebotsThymio2Controller = {
  "webots_interfaces::msg",
  "WebotsThymio2Controller",
  _WebotsThymio2Controller__cdr_serialize,
  _WebotsThymio2Controller__cdr_deserialize,
  _WebotsThymio2Controller__get_serialized_size,
  _WebotsThymio2Controller__max_serialized_size
};

static rosidl_message_type_support_t _WebotsThymio2Controller__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_WebotsThymio2Controller,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, webots_interfaces, msg, WebotsThymio2Controller)() {
  return &_WebotsThymio2Controller__type_support;
}
