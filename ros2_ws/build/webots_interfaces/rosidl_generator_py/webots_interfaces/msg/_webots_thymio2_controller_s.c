...
bool webots_interfaces__msg__webots_thymio2_controller__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("webots_interfaces.msg._webots_thymio2_controller.WebotsThymio2Controller", full_classname_dest, 72) == 0);
  }
  webots_interfaces__msg__WebotsThymio2Controller * ros_message = _ros_message;
  {  // debug_message
  ...
  {  // leds_circle
    ...
    int64_t * dest = ros_message->leds_circle.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
  ...
  {  // prox_ground_ambiant
    ...
    double * dest = ros_message->prox_ground_ambiant.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
  ...
  {  // prox_ground_delta
    ...
    double * dest = ros_message->prox_ground_delta.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
  ...
  {  // prox_ground_reflected
    ...
    double * dest = ros_message->prox_ground_reflected.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
  ...
  {  // prox_horizontal
    ...
    double * dest = ros_message->prox_horizontal.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
...
{
  /* NOTE(esteve): Call constructor of WebotsThymio2Controller */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("webots_interfaces.msg._webots_thymio2_controller");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WebotsThymio2Controller");
  ...
  {  // leds_circle
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "leds_circle");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->leds_circle.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int64_t * src = &(ros_message->leds_circle.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->leds_circle.size * sizeof(int64_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // prox_ground_ambiant
    ...
    if (ros_message->prox_ground_ambiant.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->prox_ground_ambiant.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->prox_ground_ambiant.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // prox_ground_delta
    ...
    if (ros_message->prox_ground_delta.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->prox_ground_delta.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->prox_ground_delta.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // prox_ground_reflected
    ...
    if (ros_message->prox_ground_reflected.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->prox_ground_reflected.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->prox_ground_reflected.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // prox_horizontal
    ...
    if (ros_message->prox_horizontal.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->prox_horizontal.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->prox_horizontal.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
