...
#include "webots_interfaces/msg/detail/webots_thymio2_controller__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: leds_circle
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.leds_circle[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: leds_top
...
{
  auto typed_message =
    static_cast<const webots_interfaces::msg::WebotsThymio2Controller *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<webots_interfaces::msg::WebotsThymio2Controller *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _WebotsThymio2Controller__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const webots_interfaces::msg::WebotsThymio2Controller *>(
...
{
  return max_serialized_size_WebotsThymio2Controller(full_bounded, 0);
}

static message_type_support_callbacks_t _WebotsThymio2Controller__callbacks = {
...
static rosidl_message_type_support_t _WebotsThymio2Controller__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_WebotsThymio2Controller__callbacks,
...
{
  return &webots_interfaces::msg::typesupport_fastrtps_cpp::_WebotsThymio2Controller__handle;
}
