...
class Metaclass_WebotsThymio2Controller(type):
    """Metaclass of message 'WebotsThymio2Controller'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'webots_interfaces.msg.WebotsThymio2Controller')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__webots_thymio2_controller
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__webots_thymio2_controller
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__webots_thymio2_controller
            cls._TYPE_SUPPORT = module.type_support_msg__msg__webots_thymio2_controller
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__webots_thymio2_controller
...
class WebotsThymio2Controller(metaclass=Metaclass_WebotsThymio2Controller):
    """Message class 'WebotsThymio2Controller'."""
    ...
    _fields_and_field_types = {
        ...
        'prox_comm_rx': 'string',
        'prox_comm_tx': 'string',
        'prox_ground_ambiant': 'sequence<double>',
        'prox_ground_delta': 'sequence<double>',
        'prox_ground_reflected': 'sequence<double>',
        'prox_horizontal': 'sequence<double>',
        'rc5_address': 'string',
        'rc5_command': 'string',
        'sd_present': 'boolean',
        'temperature': 'int64',
    ...
    def __init__(self, **kwargs):
        ...
        self.leds_circle = array.array('q', kwargs.get('leds_circle', []))
        ...
        self.prox_ground_ambiant = array.array('d', kwargs.get('prox_ground_ambiant', []))
        self.prox_ground_delta = array.array('d', kwargs.get('prox_ground_delta', []))
        self.prox_ground_reflected = array.array('d', kwargs.get('prox_ground_reflected', []))
        self.prox_horizontal = array.array('d', kwargs.get('prox_horizontal', []))
    ...
    def leds_circle(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'q', \
                "The 'leds_circle' array.array() must have the type code of 'q'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= -9223372036854775808 and val < 9223372036854775808 for val in value)), \
                "The 'leds_circle' field must be a set or sequence and each value of type 'int' and each integer in [-9223372036854775808, 9223372036854775807]"
        self._leds_circle = array.array('q', value)
    ...
    def prox_ground_ambiant(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'prox_ground_ambiant' array.array() must have the type code of 'd'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'prox_ground_ambiant' field must be a set or sequence and each value of type 'float'"
        self._prox_ground_ambiant = array.array('d', value)
    ...
    def prox_ground_delta(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'prox_ground_delta' array.array() must have the type code of 'd'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'prox_ground_delta' field must be a set or sequence and each value of type 'float'"
        self._prox_ground_delta = array.array('d', value)
    ...
    def prox_ground_reflected(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'prox_ground_reflected' array.array() must have the type code of 'd'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'prox_ground_reflected' field must be a set or sequence and each value of type 'float'"
        self._prox_ground_reflected = array.array('d', value)
    ...
    def prox_horizontal(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'prox_horizontal' array.array() must have the type code of 'd'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'prox_horizontal' field must be a set or sequence and each value of type 'float'"
        self._prox_horizontal = array.array('d', value)
